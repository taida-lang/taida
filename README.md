...
- Canonical public release identifier: `@a.1.alpha`
- `Cargo.toml` version `1.0.0`: semver metadata for Rust tooling

In release notes and public communication, `@a.1.alpha` is the primary version. `1.0.0` is supplementary.
